...
class ConanFromUpstream {
    ...
    void evaluateLockfiles(DockerCommandRunner dcr) {
        ...
        dcr.run("python ~/scripts/copy_direct_upstream_lockfiles.py locks/dev ${nameAndVersion}")
        dcr.run("python ~/scripts/consolidate_lockfiles.py --lockfile_base_dir=locks/dev/${nameAndVersion} ")
    }
    ...
    void performConanBuild(DockerCommandRunner dcr, String packageId) {
        ...
        dcr.run("python ~/scripts/create_package_id_map.py --conanfile_dir=workspace locks/dev")
