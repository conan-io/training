...
class conanConfigSpec extends DeclarativePipelineTest {
    @Override
    @Before
    ...
    @Test
    void conanConfigFromEnvVars() throws Exception {
        ...
        List<String> expectedCommands = [
                "conan config install http://usr:psw@gitbucket/git/root/settings.git",
        ]
